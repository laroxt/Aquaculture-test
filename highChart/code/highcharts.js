...
(function (X, N) {
  ...
  N(m, "Core/Utilities.js", [m["Core/Globals.js"]], function (f) {
    ...
    function F(b, k, t) {
      ...
      v(k)
        ? w(t)
          ...
          : b &&
            b.getAttribute &&
            ((a = b.getAttribute(k)) || "class" !== k || (a = b.getAttribute(k + "Name")))
        : S(k, function (k, t) {
            b.setAttribute(t, k);
          });
      return a;
    ...
    var a = (f.css = function (b, k) {
          ...
          if (u) {
            ...
            if (U.length && "number" === typeof a)
              if (((U = U.join(":")), c.test(U))) {
                ...
                null !== a &&
                  (a = t(a, r, g.decimalPoint, -1 < U.indexOf(",") ? g.thousandsSep : ""));
      ...
      Q = (f.normalizeTickInterval = function (b, k, a, u, H) {
        ...
        for (
          u = 0;
          u < k.length &&
          !((c = k[u]), (H && c * a >= b) || (!H && d <= (k[u] + (k[u + 1] || k[u])) / 2));
          u++
        );
    ...
    var Y = (f.addEvent = function (b, k, t, a) {
      ...
      ia = (f.setOptions = function (b) {
        ...
        (b.time || b.global) &&
          f.time.update(m(f.defaultOptions.global, f.defaultOptions.time, b.global, b.time));
        return f.defaultOptions;
      });
    e.jQuery &&
      ...
      h.prototype.initPath = function (f, h, y) {
        function e(r, d) {
          for (; r.length < w; ) {
            ...
            c &&
              "M" === g[0] &&
              (r[0] = "C" === c[0] ? ["C", g[1], g[2], g[1], g[2], g[1], g[2]] : ["L", g[1], g[2]]);
            r.unshift(g);
        ...
        function I(r, d) {
          for (; r.length < w; )
            if (
              ((d = r[r.length / n - 1].slice()), "C" === d[0] && ((d[1] = d[5]), (d[2] = d[6])), D)
            ) {
    ...
    function (f, h, m) {
      ...
      var v = (h.animObject = function (l) {
        ...
        D = (h.animate = function (l, v, w) {
          ...
          w.easing =
            "function" === typeof w.easing ? w.easing : Math[w.easing] || Math.easeInOutSine;
          w.curAnim = y(v);
          e(v, function (a, p) {
            n(l, p);
            c = new f(l, w, p);
        ...
        E.prototype.applyTextOutline = function (a) {
          ...
          if ((k = a[0]) && "none" !== k && m.svg) {
            ...
            c &&
              I &&
              a[0] &&
              ((a = a[0].cloneNode(!0)), (a.textContent = " "), b.insertBefore(a, u));
          }
        };
        ...
        E.prototype.getBBox = function (a, b) {
          ...
          if (!k) {
            ...
            t.isSVG &&
              ...
              A &&
                (k.height = t =
                  { "11px,17": 14, "13px,20": 16 }[d && d.fontSize + "," + Math.round(t)] || t),
              b &&
                ((d = b * C),
        ...
        E.prototype.updateShadows = function (a, b, k) {
          ...
          if (t)
            for (var c = t.length; c--; )
              k.call(
                t[c],
                "height" === a ? Math.max(b - (t[c].cutHeight || 0), 0) : "d" === a ? this.d : b,
                a,
                t[c]
              );
        };
      ...
      return (function (h) {
        ...
        e.prototype.updateBoxSize = function () {
          var f = this.text.element.style,
            ...
            D = this.paddingLeft,
            n =
              (L(this.widthSetting) && L(this.heightSetting) && !this.textAlign) ||
              !z(this.text.textStr)
                ? e.emptyBBox
                : this.text.getBBox();
          ...
          this.baselineOffset =
            h +
            Math.min(this.renderer.fontMetrics(f && f.fontSize, this.text).b, n.height || Infinity);
          this.needsBox &&
            (this.box ||
        ...
        E = (function () {
          ...
          u.prototype.init = function (b, k, a, c, d, g, q) {
            ...
            this.createElement("desc")
              .add()
              .element.appendChild(p.createTextNode("Created with Highcharts 8.2.2"));
                  ...
                  g.forEach(function (t, d) {
                    ...
                    q.forEach(function (t) {
                      if ("" !== t || 1 === q.length) {
                        ...
                        if ((n = x(t, "style")))
                          (n = n.replace(/(;| |^)color([ :])/, "$1fill$2")), K(u, "style", n);
                        if (
                          (r = x(t, "href")) &&
                          !c &&
                          -1 === r.split(":")[0].toLowerCase().indexOf("javascript")
                        ) {
          ...
          u.prototype.rect = function (b, k, a, c, d, g) {
            ...
            this.styledMode ||
              ("undefined" !== typeof g && ((b.strokeWidth = g), (b = t.crisp(b))),
              (b.fill = "none"));
            d && (b.r = d);
                ...
                B[b + "Setter"] = function (b, k) {
                  ...
                  e(t) &&
                    (g &&
                      ...
                      this.height &&
                      (t = Math.round(
                        t * Math.min(this.width / this.imgwidth, this.height / this.imgheight)
                      )),
          ...
          if (this.added) {
            ...
            if ("SPAN" === f.tagName) {
              ...
              (c = d !== this.oldTextWidth) &&
                !(c = d > this.oldTextWidth) &&
                ((c = this.textPxLength) ||
                  (z(f, { width: "", whiteSpace: r || "nowrap" }), (c = f.offsetWidth)),
                (c = c > d));
              c &&
              (/[ \-]/.test(f.textContent || f.innerText) || "ellipsis" === f.style.textOverflow)
    ...
    h = (function () {
      ...
      f.prototype.addLabel = function () {
        ...
        if (l.dateTime && q) {
          var D = w.time.resolveDTLFormat(
            e.dateTimeLabelFormats[(!e.grid && q.higherRanks[c]) || q.unitName]
          );
          var x = D.main;
        }
        n.isFirst = p;
        ...
        if ((h = D && D.list))
          n.shortenLabel = function () {
            for (f = 0; f < h.length; f++)
              if (
                (A.attr({
                  text: l.labelFormatter.call(K(n.formatCtx, { dateTimeLabelFormat: h[f] })),
                }),
      ...
      f.prototype.createLabel = function (n, l, f) {
        var w = this.axis,
          r = w.chart;
        if (
          (n = F(l) && f.enabled ? r.renderer.text(l, n.x, n.y, f.useHTML).add(w.labelGroup) : null)
        )
      ...
      f.prototype.getPosition = function (n, l, e, w) {
        ...
        n = {
          x: n
            ...
            : r.left +
              r.offset +
              (r.opposite ? ((w && d.oldChartWidth) || d.chartWidth) - r.right - r.left : 0),
          y: n
      ...
      f.prototype.getLabelPosition = function (n, l, e, w, r, d, g, c) {
        var a = this.axis,
          ...
          f = r.y,
          h =
            w || a.reserveSpaceDefault ? 0 : -a.labelOffset * ("center" === a.labelAlign ? 0.5 : 1),
          v = {};
        F(f) ||
          (f =
            0 === a.side
        ...
        B &&
          ((e = (g / (c || 1)) % B), a.opposite && (e = B - e - 1), (l += (a.labelOffset / B) * e));
        v.x = n;
        v.y = Math.round(l);
    ...
    h = (function () {
      ...
      h.prototype.makeTime = function (n, l, h, w, r, d) {
        if (this.useUTC) {
          ...
          c !== a
            ? (g += a - c)
            : c - 36e5 !== this.getTimezoneOffset(g - 36e5) || f.isSafari || (g -= 36e5);
      ...
      h.prototype.dateFormat = function (n, l, h) {
        ...
        if (!m(l) || isNaN(l))
          return (
            (null === (w = f.defaultOptions.lang) || void 0 === w ? void 0 : w.invalidDate) || ""
          );
        n = e(n, "%Y-%m-%d %H:%M:%S");
        var r = this;
        w = new this.Date(l);
      ...
      h.prototype.getTimeTicks = function (n, l, f, h) {
        ...
        if (m(l)) {
          ...
          a >= v.second &&
            r.set("Seconds", c, a >= v.minute ? 0 : q * Math.floor(r.get("Seconds", c) / q));
          a >= v.minute &&
            r.set("Minutes", c, a >= v.hour ? 0 : q * Math.floor(r.get("Minutes", c) / q));
          a >= v.hour && r.set("Hours", c, a >= v.day ? 0 : q * Math.floor(r.get("Hours", c) / q));
          a >= v.day &&
            r.set("Date", c, a >= v.month ? 1 : Math.max(1, q * Math.floor(r.get("Date", c) / q)));
          if (a >= v.month) {
          ...
          a === v.week &&
            ((B = r.get("Day", c)), r.set("Date", c, r.get("Date", c) - B + h + (B < h ? -7 : 0)));
          B = r.get("FullYear", c);
          h = r.get("Month", c);
          var A = r.get("Date", c),
            w = r.get("Hours", c);
          l = c.getTime();
          r.variableTimezone &&
            (p = f - l > 4 * v.month || r.getTimezoneOffset(l) !== r.getTimezoneOffset(f));
          l = c.getTime();
          for (c = 1; l < f; )
            d.push(l),
              (l =
  ...
  N(
    ...
    function (f, h, m, z) {
      ...
      ("");
      f.defaultOptions = {
        colors: "#189ad3 #45B8AC #665191 #a05195 #d45087 #f95d6a #e4d354 #ff7c43 #ffa600 #91e8e1".split(
          " "
        ),
    ...
    function (f, h, m, z, F, L) {
      ...
      f = (function () {
        ...
        u.prototype.init = function (b, k) {
          ...
          k = c.options.events;
          -1 === b.axes.indexOf(c) &&
            (a ? b.axes.splice(b.xAxis.length, 0, c) : b.axes.push(c), b[c.coll].push(c));
          c.series = c.series || [];
              ...
              if (t.visible || !k.options.chart.ignoreHiddenSeries) {
                ...
                if (b.isXAxis) {
                  if (((d = t.xData), d.length)) {
                    ...
                    c(p) ||
                      p instanceof Date ||
                      ((d = d.filter(c)), (a = t.getXExtremes(d)), (p = a.min), (q = a.max));
                    d.length &&
        ...
        u.prototype.translate = function (b, a, t, d, g, p) {
          ...
          g =
            (k.isOrdinal || (k.brokenAxis && k.brokenAxis.hasBreaks) || (k.logarithmic && g)) &&
            k.lin2val;
          H || (H = k.transA);
          t && ((q *= -1), (e = k.len));
          ...
          a
            ...
            : (g && (b = k.val2lin(b)),
              (b = c(d) ? q * (b - d) * H + e + q * u + (c(p) ? H * p : 0) : void 0));
          return b;
        };
        ...
        u.prototype.getMinorTickPositions = function () {
          ...
          if (q && q / c < this.len / 3) {
            ...
            if (e)
              ...
              d = d.concat(
                this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(c), p, g, b.startOfWeek)
              );
        ...
        u.prototype.unsquish = function () {
          ...
          a
            ? (l =
                !b.staggerLines &&
                !b.step &&
                (x(q) ? [q] : g < A(b.autoRotationLimit, 80) && b.autoRotation)) &&
        ...
        u.prototype.getSlotWidth = function (b) {
          ...
          if (!g) {
            b =
              null === (a = null === p || void 0 === p ? void 0 : p.style) || void 0 === a
                ? void 0
                : a.width;
        ...
        u.prototype.renderUnsquish = function () {
          ...
          if (this.autoRotation)
            n > u && n > l.h ? (B.rotation = this.labelRotation) : (this.labelRotation = 0);
          else if (e) {
            var A = u;
            if (!r) {
              var f = "clip";
          ...
          B.rotation &&
            ((A = n > 0.5 * b.chartHeight ? 0.33 * b.chartHeight : n), r || (f = "ellipsis"));
          ...
          D || b.isLinked
            ? (g.forEach(function (a, c) {
              ...
              (b.reserveSpaceDefault =
                0 === e || 2 === e || { 1: "left", 3: "right" }[e] === b.labelAlign),
          ...
          if (b.hasData() || p)
            b.minorTickInterval &&
              ...
              q.length &&
                ...
                A &&
                  (0 === b.min || b.single) &&
                  (u[-1] || (u[-1] = new z(b, -1, null, !0)), u[-1].render(-1))),
              f &&
        ...
        u.prototype.drawCrosshair = function (b, a) {
          ...
          if (this.crosshair && !1 !== (x(a) || !k)) {
            ...
            if (x(d)) {
              ...
              p.polar &&
                l(q, { isCrosshair: !0, chartX: b && b.chartX, chartY: b && b.chartY, point: a });
        ...
        u.prototype.hasVerticalPanning = function () {
          ...
          return /y/.test(
            (null ===
              (a = null === (b = this.chart.options.chart) || void 0 === b ? void 0 : b.panning) ||
            void 0 === a
              ? void 0
              : a.type) || ""
          );
    ...
    function (f, h, m) {
          ...
          n.chart.styledMode ||
            (p
              ...
              : q &&
                ((G.fill = M || "#e6ebf5"),
                w.borderWidth &&
                  ((G.stroke = w.borderColor), (G["stroke-width"] = w.borderWidth))));
          O.zIndex = x;
          u += "-" + x;
      ...
      y(f.prototype, {
        ...
        removePlotBandOrLine: function (e) {
          for (
            var f = this.plotLinesAndBands, n = this.options, l = this.userOptions, h = f.length;
            h--;

          )
            f[h].id === e && f[h].destroy();
          [n.plotLines || [], l.plotLines || [], n.plotBands || [], l.plotBands || []].forEach(
            function (f) {
    ...
    var w = (function () {
      ...
      r.prototype.applyFilter = function () {
        ...
        d.renderer.definition({
          tagName: "style",
          textContent:
            ".highcharts-tooltip-" + d.index + "{filter:url(#drop-shadow-" + d.index + ")}",
        });
      };
      r.prototype.bodyFormatter = function (d) {
        return d.map(function (d) {
          ...
          return (
            c[(d.point.formatPrefix || "point") + "Formatter"] || d.point.tooltipFormatter
          ).call(d.point, c[(d.point.formatPrefix || "point") + "Format"] || "");
        });
      };
      ...
      r.prototype.getPosition = function (d, g, c) {
        var a = this.chart,
          ...
          U = function (b, a, c, k, d) {
            ...
            d < q || d > a - q
              ? (g = !1)
              : (p[b] = d < c / 2 ? 1 : d > a - k / 2 ? a - k - 2 : d - c / 2);
            return g;
          },
          x = function (b) {
            var a = k;
      ...
      f = (function () {
            ...
            if (
              ...
              a.hasCartesianSeries &&
                ...
                ((this.selectionMarker = E = a.renderer
                  ...
                  .add()),
                a.styledMode ||
                  E.attr({ fill: d.selectionMarkerFill || F("#335cad").setOpacity(0.25).get() }));
          ...
          a.cancelClick ||
            (d && this.inClass(c.target, "highcharts-tracker")
              ...
              : (v(c, this.getCoordinates(c)),
                a.isInsidePlot(c.chartX - g, c.chartY - e) && D(a, "click", c)));
        };
        ...
        g.prototype.pinch = function (c) {
          var a = this,
            ...
            m =
              1 === f &&
              ((a.inClass(c.target, "highcharts-tracker") && d.runTrackerClick) || a.runChartClick),
            E = {};
          1 < f && (a.initiated = !0);
        ...
        g.prototype.pinchTranslateDirection = function (c, a, d, g, e, f, l, r) {
          ...
          x
            ? ((m -= 0.8 * (m - l[q][0])), "number" === typeof M && (M -= 0.8 * (M - l[q][1])), d())
            : (l[q] = [m, M]);
          w || ((f[q] = t - b), (f[u] = k));
          f = w ? 1 / B : B;
          e[u] = k;
        ...
        g.prototype.runPointActions = function (c, a) {
          ...
          if (f && (f !== d.hoverPoint || (g && g.isHidden))) {
            ...
            a &&
              g &&
              !g.isHidden &&
              ((f = g.getAnchor([{}], c)), g.updatePosition({ plotX: f[0], plotY: f[1] }));
          this.unDocMouseMove ||
        ...
        g.prototype.setDOMEvents = function () {
          ...
          h.unbindDocumentMouseUp ||
            (h.unbindDocumentMouseUp = C(a, "mouseup", this.onDocumentMouseUp.bind(this)));
          h.hasTouch &&
            ...
            if (
              ...
              if ("touchmove" === c.type) {
                ...
                var e = a[0]
                  ? 4 <=
                    Math.sqrt(
                      Math.pow(a[0].chartX - c.chartX, 2) + Math.pow(a[0].chartY - c.chartY, 2)
                    )
                  : !1;
              }
              r(e, !0) && this.pinch(c);
        ...
        g = (function () {
          ...
          c.prototype.colorizeItem = function (a, c) {
            ...
            if (!this.chart.styledMode) {
              ...
              e && e.attr({ stroke: l });
              f &&
                (r && f.isMarker && ((n = a.pointAttribs()), c || (n.stroke = n.fill = q)),
                f.attr(n));
            }
          ...
          c.prototype.layoutItem = function (a) {
            ...
            this.offsetWidth =
              this.widthOption ||
              Math.max((g ? this.itemX - d - (a.checkbox ? 0 : r) : c) + d, this.offsetWidth);
          };
          ...
          c.prototype.render = function () {
            ...
            0 < r &&
              ...
              (g[g.isNew ? "attr" : "animate"](
                g.crisp.call({}, { x: 0, y: 0, width: r, height: h }, g.strokeWidth())
              ),
              (g.isNew = !1));
            g[n ? "show" : "hide"]();
            ...
            0 < l &&
              ...
              [this.down, this.downTracker].forEach(function (a) {
                a.attr({
                  ...
                  class:
                    l === f ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active",
                });
              }, this),
              g.styledMode ||
    ...
    function (f, h, m) {
      ...
      f = (function () {
        ...
        f.prototype.animateBeforeDestroy = function () {
          ...
          c.plural.forEach(function (a) {
            e[a].forEach(function (a) {
              a.element &&
                a.animate(
                  K({ x: e.startXPos }, a.startYPos ? { x: a.startXPos, y: a.startYPos } : {})
                );
            });
          });
        };
        ...
        f.prototype.firePointEvent = function (e, d, g) {
          ...
          (a.point.events[e] || (c.options && c.options.events && c.options.events[e])) &&
            c.importEvents();
          "click" === e &&
            a.allowPointSelect &&
            (g = function (a) {
        ...
        W = (function () {
          ...
          f.prototype.applyDescription = function (a, c) {
            var d = this,
              g =
                "title" === a
                  ? { color: "#333333", fontSize: this.options.isStock ? "13px" : "15px" }
                  : { color: "#666666" };
          ...
          f.prototype.drawChartBox = function () {
            var a = this.options.chart,
              ...
              B = "animate";
            g ||
              ((this.chartBackground = g = b.rect().addClass("highcharts-background").add()),
              (B = "attr"));
          ...
          f.prototype.firstRender = function () {
            ...
            if (!a.isReadyToRender || a.isReadyToRender()) {
              ...
              C &&
                (a.pointer =
                  z.hasTouch || (!l.PointerEvent && !l.MSPointerEvent) ? new C(a, b) : new L(a, b));
              a.render();
        ...
        y = (function () {
          ...
          e.prototype.renderStackTotals = function () {
            ...
            var n = (this.stackTotalGroup =
              ...
              h.g("stack-labels").attr({ visibility: "visible", zIndex: 6, opacity: 0 }).add());
        ...
        },
        {
          ...
          updateData: function (a, c) {
            ...
            a.forEach(function (a, c) {
              var f =
                (l(a) && this.pointClass.prototype.optionsToObject.call({ series: this }, a)) || {};
              var t = f.x;
              if (f.id || p(t)) {
                if (
          ...
          sortData: function (a) {
            var b = this,
              ...
              g = function (a, b) {
                return (
                  (l(b) && a.pointClass.prototype.optionsToObject.call({ series: a }, b)) || {}
                );
              };
            ...
            for (m = 0; m < u; m++) {
              var x = q[m],
                ...
                J =
                  c &&
                  h.stacking &&
                  h.stacking.stacks[(this.negStacks && z < (B ? 0 : A) ? "-" : "") + this.stackKey];
              if (
          ...
          getClipBox: function (a, c) {
            ...
            a && !1 === b.clip && e
              ...
              : ((a = this.clipBox || d.clipBox),
                c &&
                  ((a.width = d.plotSizeX),
                  (a.x = (d.scrollablePixelsX || 0) * (f.scrollPositionX || 0))));
          ...
          animate: function (a) {
            ...
            if (!b.hasRendered)
              if (a) this.setClip(c);
                ...
                a && a.animate(g, c);
                b[d + "m"] &&
                  b[d + "m"].animate({ width: g.width + 99, x: g.x - (b.inverted ? 0 : 99) }, c);
              }
          },
          ...
          getZonesGraphs: function (a) {
            this.zones.forEach(function (b, c) {
              ...
              this.chart.styledMode ||
                c.push(b.color || this.color, b.dashStyle || this.options.dashStyle);
              a.push(c);
            }, this);
            return a;
          },
          ...
          for (D = 0; D < r; D++) {
            ...
            "percent" === f
              ? ((G = G ? e : a),
                q && v[G] && v[G][y]
                  ? ((G = v[G][y]),
                    (u.total = G.total = Math.max(G.total, u.total) + Math.abs(z) || 0))
            ...
            null !== z &&
              (u.points[E].push(u.cumulative), (w[D] = u.cumulative), (u.hasValidPoints = !0));
          }
    ...
    function (f, h, m, z, F, L, K, C, y, e) {
      ...
      g(L.prototype, {
        ...
        hasOptionChanged: function (a) {
          ...
          return b
            ? c !== b
            : c !== M(d && d[this.type] && d[this.type][a], d && d.series && d.series[a], c);
        },
      });
      g(h.prototype, {
        update: function (a, c) {
          ...
          drawGraph: function () {
            ...
            m.forEach(function (m) {
              ...
              l
                ...
                : ((w.zIndex = 0),
                  (l = e[n] = e.chart.renderer.path(f).addClass(m[1]).add(e.group)),
                  (l.isArea = !0));
              e.chart.styledMode ||
                (w.fill = C(m[3], L(m[2]).setOpacity(C(h.fillOpacity, 0.75)).get()));
              l[v](w);
              l.startX = f.xMap;
        ...
        },
        {
          ...
          getColumnMetrics: function () {
            ...
            e.columnMetrics = {
              width: f,
              offset:
                (v - f) / 2 + (m + ((e.columnIndex || 0) + (c ? 1 : 0)) * v - n / 2) * (c ? -1 : 1),
              paddedWidth: v,
              columnCount: p,
            };
          ...
          translate: function () {
            ...
            f.points.forEach(function (g) {
              ...
              I(g.options.pointWidth) &&
                ((k = w = Math.ceil(g.options.pointWidth)), (r -= Math.round((k - v) / 2)));
            ...
            e.points.forEach(function (h) {
              ...
              if (D(h.plotY) && null !== h.y) {
                ...
                e.enabledDataSorting &&
                  (h.startXPos = e.xAxis.reversed ? -(a ? a.width : 0) : e.xAxis.width);
                p ||
  ...
  N(
    ...
    function (f, h, m, z) {
                ...
                a.styledMode ||
                  ...
                  "contrast" === r.color
                    ? ((g.contrastColor = C.getContrast(g.color || c.color)),
                      (r.color =
                        (!y(m) && e.inside) || 0 > m || f.stacking ? g.contrastColor : "#000000"))
              ...
              !k || (b && y(u))
                ? b &&
                  ...
                  e.textPath &&
                    !e.useHTML &&
                    (k.setTextPath(
                      (g.getDataLabelPath && g.getDataLabelPath(k)) || g.graphic,
                      e.textPath
                    ),
                    g.dataLabelPath &&
                      !e.textPath.enabled &&
                ...
                : ((g.dataLabel = g.dataLabel && g.dataLabel.destroy()),
                  g.dataLabels &&
                    (1 === g.dataLabels.length ? delete g.dataLabels : delete g.dataLabels[h]),
                  h || delete g.dataLabel,
                  p &&
                    ((g.connector = g.connector.destroy()),
                    g.connectors &&
                      (1 === g.connectors.length ? delete g.connectors : delete g.connectors[h])));
            });
          });
        }
      ...
      m.prototype.alignDataLabel = function (d, g, c, a, f) {
        ...
        if (k) {
          ...
          x
            ? ((b = !1),
              ...
              (r = {
                ...
                y:
                  a.y + (c.y || 0) + { top: 0, middle: 0.5, bottom: 1 }[c.verticalAlign] * a.height,
              }),
              t(r),
          ...
          b && 0 <= a.height
            ...
            : l(c.crop, !0) &&
              (k = n.isInsidePlot(r.x, r.y) && n.isInsidePlot(r.x + w.width, r.y + w.height));
          if (c.shape && !x)
            g[f ? "attr" : "animate"]({
      ...
      m.prototype.justifyDataLabel = function (d, e, c, a, f, h) {
        ...
        q = c.x + a.width - n;
        q > g.plotWidth &&
          ("left" === p && 0 >= m ? ((e.align = "right"), (e.inside = !0)) : (m += g.plotWidth - q),
          (v = !0));
        q = c.y + n;
        0 > q &&
          ("bottom" === l && 0 <= r ? ((e.verticalAlign = "top"), (e.inside = !0)) : (r -= q),
          (v = !0));
        q = c.y + a.height - n;
        q > g.plotHeight &&
          ("top" === l && 0 >= r
                ...
                for (P = 0; P < n; P++) {
                  ...
                  l(f.crop, !0) &&
                    ...
                    J - k < p && 1 === g
                      ...
                      : J + k > r - p &&
                        0 === g &&
                        ((A = Math.round(J + k - r + p)), (S[1] = Math.max(A, S[1]))),
                    0 > L - F / 2
          ...
          if (
            ...
            a && a.size && m && "hidden" !== f && !this.isCluster
              ? (r || (d.halo = r = k.renderer.path().add(m.parentGroup)),
                ...
                k.styledMode ||
                  r.attr(
                    l({ fill: this.color || d.color, "fill-opacity": a.opacity }, a.attributes)
                  ))
              : r &&
                r.point &&
                r.point.haloPath &&
