  ...
  u(
    ...
    function (m, u, y, H, w) {
      ...
      function C(e, d, a, l, f, g, b, k) {
        return (
          B(e, d, f, g, b, k) !== B(a, l, f, g, b, k) && B(e, d, a, l, f, g) !== B(e, d, a, l, b, k)
        );
      }
        ...
        if (this.renderer) {
          ...
          d.series.forEach(function (l) {
            ...
            f.enabled &&
              ...
              "load" === e.type && (a = Math.max(a, D(l.options.animation).duration)),
              b &&
      ...
      y.prototype.labelFontSize = function (e, d) {
            ...
            if (a.visible && !a.isSeriesBoosting && c) {
              q ||
                ...
                e.renderer.styledMode ||
                  (q.css(
                    G({ color: v ? e.renderer.getContrast(a.color) : a.color }, f.style || {})
                  ),
                  q.attr({
              ...
              if (g.length) {
                if (
                  ...
                  (c = Math.sqrt(
                    ...
                    (c = void 0),
                    w && ((c = D(a.options.animation)), (c.duration *= 0.2)),
                    a.labelBySeries
                      .attr(
                        G(g, {
