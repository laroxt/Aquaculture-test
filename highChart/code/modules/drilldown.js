  ...
  m(
    ...
    function (c, m, n, y, w, p, z, E, B, k) {
      ...
      n.prototype.getDrilldownBackText = function () {
        ...
        if (a && 0 < a.length)
          return (
            (a = a[a.length - 1]), (a.series = a.seriesOptions), H(this.options.lang.drillUpText, a)
          );
      };
          ...
          for (
            ...
            if (((c = b[e]), c.levelNumber === d)) {
              ...
              if (!h.chart)
                for (g = f.length; g--; )
                  if (
                    f[g].options.id === c.lowerSeriesOptions.id &&
                    f[g].options._levelNumber === d + 1
                  ) {
                    h = f[g];
                    break;
                  }
          ...
          a.series.forEach(function (b) {
            ...
            for (d = 0; d < e.length; d++) {
              ...
              "number" !== typeof c &&
                ...
                c.drilldown &&
                  (a.ddPoints[e[d]] || (a.ddPoints[e[d]] = []),
                  a.ddPoints[e[d]].push(f ? f[d] : !0)));
            }
          });
        ...
        a ||
          (e.forEach(function (a) {
            b.options._ddSeriesId === a.lowerSeriesOptions._ddSeriesId &&
              ((c = a.shapeArgs), h || (c.fill = a.color));
          }),
            ...
            if (this.center) {
              ...
              a ||
                (this.points.forEach(function (a, e) {
                  ...
                  if (a.graphic)
                    a.graphic
                      .attr(u(c, { start: f + e * g, end: f + (e + 1) * g }))
                      [d ? "animate" : "attr"](h, d);
                }),
                delete this.animate);
            }
      ...
      z.prototype.doDrilldown = function (a, b, d) {
        ...
        x(
          ...
          function (b) {
            ...
            d &&
              c &&
              (a ? d.addSingleSeriesAsDrilldown(b.point, c) : d.addSeriesAsDrilldown(b.point, c));
          }
        );
      };
      ...
      q(w.Series, "afterDrawDataLabels", function () {
        ...
        this.points.forEach(function (d) {
          ...
          d.drilldown &&
            d.dataLabel &&
            ("contrast" !== a.color || c || (e.color = b.getContrast(d.color || this.color)),
