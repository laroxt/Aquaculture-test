...
//           var f = this.chart;
//           if (this.isOpen && this.browserProps && f.container.ownerDocument instanceof Document)
...
//             l =
//               null === (f = null === k || void 0 === k ? void 0 : k.buttons) || void 0 === f
//                 ? void 0
...
//           g.printingChart &&
//             (a.matches ? g.printingChart.beforePrint() : g.printingChart.afterPrint());
//         });
//       z(e.prototype, {
...
//             (c.isGantt ? 800 : 600);
//           w =
//             c.exporting.sourceHeight || c.chart.height || (/px$/.test(w) && parseInt(w, 10)) || 400;
//           z(c.chart, {
//             animation: !1,
//             renderTo: d,
//             forExport: !0,
...
//           b &&
//             this.chartWidth > b &&
//             ((c.resetParams = [this.options.chart.width, void 0, !1]), this.setSize(b, void 0, !1));
...
//               "div",
//               { className: a },
//               { position: "absolute", zIndex: 1e3, padding: u + "px", pointerEvents: "auto" },
...
//               : d.text || z(h, { width: d.width, height: d.height, padding: 0 });
//             b.styledMode ||
...
//               .attr({ title: t(b.options.lang[d._titleKey || d.titleKey], "") });
